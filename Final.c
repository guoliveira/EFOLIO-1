    ...
    if (verificar_posicao(origem)==0||verificar_posicao(destino)==0)
        ...
        case 'p':
            if (tabuleiro[para_int]=='R')
                ...
                return 1;
            else if (tabuleiro[de_int]=='.'&&vertical[0]==0&&(de_int-para_int<8&&para_int-de_int<8))
                return 1;
            else
                return 0;
            break;
        case 'P':
            if (tabuleiro[para_int]=='r')
                return -1;
            else if (tabuleiro[para_int]=='p' && (diagonal[2]==0||diagonal[3]==0)&&(de_int-para_int<8&&para_int-de_int<8))
                return 1;
            else if (tabuleiro[para_int]=='.'&&vertical[1]==0&&(de_int-para_int<8&&para_int-de_int<8))
                return 1;
            else
                return 0;
            break;
        case 'r':
            if (tabuleiro[para_int]=='R'&&(de_int-para_int==1||para_int-de_int==1||vertical[0]==0||vertical[1]==0||diagonal[0]==0|| diagonal[1]==0||diagonal[2]==0||diagonal[3]==0)&&(de_int-para_int<8&&para_int-de_int<8))
                return -1;
            else if (tabuleiro[para_int]=='p')
                return 0;
            else if (de_int-para_int==1||para_int-de_int==1||vertical[0]==0||vertical[1]==0||diagonal[0]==0|| diagonal[1]==0||diagonal[2]==0||diagonal[3]==0)
                return 1;
            else
                return 0;
            break;
        case 'R':
            if (tabuleiro[para_int]=='r'&&(de_int-para_int==1||para_int-de_int==1||vertical[0]==0||vertical[1]==0||diagonal[0]==0|| diagonal[1]==0||diagonal[2]==0||diagonal[3]==0)&&(de_int-para_int<8&&para_int-de_int<8))
                ...
                return 0;
            else if ((de_int-para_int==1||para_int-de_int==1||vertical[0]==0||vertical[1]==0||diagonal[0]==0|| diagonal[1]==0||diagonal[2]==0||diagonal[3]==0)&&(de_int-para_int<8&&para_int-de_int<8))
                return 1;
            else
                return 0;
            break;
